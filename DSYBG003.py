...
print "get result for key word search"
wmp = AllData()
setting = NetWorkSetting()
setting.searchKey = "python_friend"
...
print "for all weixinhao exist in glable data, get the source and get all the topics for each weixinhao, then write to glable data"
tempindex = 1
...
print "start to scrapy real topic for every weixinhao"
for weixin in wmp.m_weixins:
